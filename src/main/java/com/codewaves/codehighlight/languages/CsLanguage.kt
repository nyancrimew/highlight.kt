...
class CsLanguage : LanguageBuilder  {
 ...
 value = "null false true"
  ...
  val INTERPOLATED_VERBATIM_STRING_NO_LF = hljs.inherit(INTERPOLATED_VERBATIM_STRING, Mode(
    illegal = """\n""",
  ...
  SUBST_NO_LF.contains = listOf(
    ...
    hljs.QUOTE_STRING_MODE,
    NUMBERS,
    hljs.inherit(hljs.C_BLOCK_COMMENT_MODE, Mode(illegal = """\n"""))
  );
  val STRING = Mode(
    variants = listOf(
      INTERPOLATED_VERBATIM_STRING,
  ...
  val TYPE_IDENT_RE = hljs.IDENT_RE + "(<" +
 hljs.IDENT_RE + "(\\s*,\\s*" +
 hljs.IDENT_RE + ")*>)?(\\[\\))?";

  override fun build() = Mode(
    aliases = listOf("csharp",
 "c#"),
 ...
 relevance = 0
      ...
      Mode(
        ...
        keywords = listOf(
          Keyword(className = "meta-keyword",
