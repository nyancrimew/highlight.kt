 ...
 * Origin highlight.js/src/languages/isbl.js MD5 <5a372af48469608cc3d00602a9abef28>
 */
internal fun isbl(): Mode {
    ...
    var requisite_compType2_values_constants =
        "COMPTYPE2_REQUISITE_DOCUMENTS_VALUE COMPTYPE2_REQUISITE_TASKS_VALUE COMPTYPE2_REQUISITE_FOLDERS_VALUE COMPTYPE2_REQUISITE_REFERENCES_VALUE "
    // Requisite name
    ...
    var script_block_properties_constants =
        "SCRIPT_BLOCK_AFTER_FINISH_EVENT SCRIPT_BLOCK_BEFORE_START_EVENT SCRIPT_BLOCK_EXECUTION_RESULTS_PROPERTY SCRIPT_BLOCK_NAME_PROPERTY SCRIPT_BLOCK_SCRIPT_PROPERTY "
    ...
    var using_the_dialog_windows_constants =
        "ATTENTION_CAPTION cbsCommandLinks cbsDefault CONFIRMATION_CAPTION ERROR_CAPTION INFORMATION_CAPTION mrCancel mrOk "
    // Using the document
    ...
    var sysres_common_constants =
        "SYSRES_COMMON SYSRES_CONST SYSRES_MBFUNC SYSRES_SBDATA SYSRES_SBGUI SYSRES_SBINTF SYSRES_SBREFDSC SYSRES_SQLERRORS SYSRES_SYSCOMP "
    // Константы ==> built_in
    var CONSTANTS =
        sysres_constants +
            base_constants +
    ...
    var TActionEnabledMode =
        "aemEnabledAlways aemDisabledAlways aemEnabledOnBrowse aemEnabledOnEdit aemDisabledOnBrowseEmpty "
    // enum TAddPosition
    ...
    // enum TCompType
    var TCompType =
        "ctDocument ctReference ctScript ctUnknown ctReport ctDialog ctFunction ctFolder ctEDocument ctTask ctJob ctNotice ctControlJob "
    ...
    // enum TContentKind
    var TContentKind =
        "ckFolder ckEDocument ckTask ckJob ckComponentToken ckAny ckReference ckScript ckReport ckDialog "
    // enum TControlType
    var TControlType =
    ...
    // enum TReqDataType
    var TReqDataType =
        "rdtString rdtNumeric rdtInteger rdtDate rdtReference rdtAccount rdtText rdtPick rdtUnknown rdtLargeInteger rdtDocument "
    ...
    var TStructuredObjectAttributeType =
        "soatString soatNumeric soatInteger soatDatetime soatReferenceRecord soatText soatPick soatBoolean soatEDocument soatAccount soatIntegerCollection soatNumericCollection soatStringCollection soatPickCollection soatDatetimeCollection soatBooleanCollection soatReferenceRecordCollection soatEDocumentCollection soatAccountCollection soatContents soatUnknown "
    ...
    var TWorkflowBlockType =
        "wsbStart wsbFinish wsbNotice wsbStep wsbDecision wsbWait wsbMonitor wsbScript wsbConnector wsbSubTask wsbLifeCycleStage wsbPause "
    ...
    var ISBL_BLOCK_COMMENT_MODE = Mode(
        className = "comment",
        begin = "/\\*",
        end = "\\*/",
        relevance = 0,
