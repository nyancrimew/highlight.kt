...
class CppLanguage : LanguageBuilder  {
 ...
 CPP_PRIMITIVE_TYPES)
      ...
      Mode(
        ...
        variants = listOf(
          ...
          Mode(beginKeywords = keywords("new throw return else",
        ...
        contains = EXPRESSION_CONTAINS + listOf(
          Mode(
            ...
            keywords = keywords(CPP_KEYWORDS),
            contains = EXPRESSION_CONTAINS + listOf("self")),
 ...
 contains = listOf("self")), // skip generic stuff
          hljs.TITLE_MODE
        )
      )
    )),
    Keyword(className = "exports",

 value = Mode(
      preprocessor = PREPROCESSOR),
      Keyword(className = "strings",
