 ...
 */
class PuppetLanguage : LanguageBuilder  {

  val PUPPET_KEYWORDS = listOf(
 ...
 "\$");
  ...
  val IDENT_RE = "(listOf(A-Za-z_]|::)(\\w|::)*";

  val TITLE = hljs.inherit(hljs.TITLE_MODE, Mode(begin = IDENT_RE));

  val VARIABLE = Mode(className = "variable",
