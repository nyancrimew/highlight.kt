 ...
 */
class XmlLanguage : LanguageBuilder  {
  val XML_IDENT_RE = "[A-Za-z0-9\\._:-]+";
  val TAG_INTERNALS = Mode(
    endsWithParent = true,
    illegal = """<""",
 ...
 relevance = 10
      ...
      Mode(
        ...
        contains = listOf(
          ...
          // inside any of the following blocks =           {begin = "/\\*",
 ...
 returnEnd = true,
          subLanguage = listOf("actionscript",
 "javascript",
 "handlebars",
 "xml",
 "vbscript")
