 ...
 * Origin highlight.js/src/languages/xquery.js MD5 <093710e52b61acaaae86d5fb77463586>
 */
...
// do not highlight inbuilt strings as variable or xml element names
            ...
            Mode(
                begin =
                    """\b(?:util|db|functx|app|xdmp|xmldb):""",
                end =
                    """\(""",
                excludeEnd = true
            )
    ...
    var TITLE = Mode(
        className = "title",
        begin =
            """\bxquery version "[13]\.[01]\"\s?(?:encoding \".+")?""",
        end =
            """;"""
    )
    var VAR = Mode(
