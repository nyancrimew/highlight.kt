 ...
 * Origin highlight.js/src/languages/d.js MD5 <8703202cc851e4355d004a1090ba2232>
 */
internal fun d(): Mode {
    /**
     * Language keywords
     ...
     * @type {Object)
     */
    var D_WYSIWYG_DELIMITED_STRING_MODE = Mode(
        className = "string",
        begin = "[rq]\"",
        end = "\"[cwd]?",
        relevance = 5
     ...
     * @type {Object)
     */
    var D_ALTERNATE_WYSIWYG_STRING_MODE = Mode(
        className = "string",
        begin = "`",
        end = "`[cwd]?"
    )
