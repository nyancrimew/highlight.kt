 ...
 * Origin highlight.js/src/languages/lsl.js MD5 <b9cb81449b2660cb63b812b3dd0712cb>
 */
internal fun lsl(): Mode {
    ...
    var LSL_NUMBERS = Mode(
        className = "number",
        begin = hljs.C_NUMBER_RE
    )
    var LSL_CONSTANTS = Mode(
        className = "literal",
        variants = listOf(
            Mode(
